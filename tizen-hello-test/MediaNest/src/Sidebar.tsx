...
export type SidebarView = "browse" | "search" | "downloads" | "streams" | "cineby" | "remote";

export const SIDEBAR_VIEWS: SidebarView[] = ["browse", "search", "downloads", "streams", "cineby", "remote"];
